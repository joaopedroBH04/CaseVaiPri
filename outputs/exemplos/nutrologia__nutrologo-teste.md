...
- Pais: **BR**
- Gerado em (UTC): **2026-05-20T06:46:47.671540+00:00**
...
> Foram encontradas apenas 9 referencias que cumprem TODOS os criterios (anuncio ativo, especialidade nutrologia, perfil acessivel). Conforme orientacao do case, NAO completamos a lista com perfis ruins. Total bruto de candidatos: 12; filtrados por especialidade: 3; sem anuncio ativo: 0.

## Termos de busca usados na Ad Library

`nutrologo`, `nutrologa`, `emagrecimento`, `obesidade`, `perda de peso`, `ozempic`, `tratamento metabolico`, `consultoria nutricional medica`, `saude metabolica`, `reposicao hormonal`
